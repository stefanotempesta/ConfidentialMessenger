...
enum
{
    ...
    fileencryptor_fcn_id_read_file = 3,
    fileencryptor_fcn_id_oe_get_sgx_report_ecall = 4,
    fileencryptor_fcn_id_oe_get_report_v2_ecall = 5,
    fileencryptor_fcn_id_oe_verify_local_report_ecall = 6,
    fileencryptor_fcn_id_oe_sgx_init_context_switchless_ecall = 7,
    fileencryptor_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall = 8,
...
typedef struct _read_file_args_t
{
    oe_result_t result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
...
oe_result_t fileencryptor_read_file(oe_enclave_t* enclave)
{
    oe_result_t _result = OE_FAILURE;
    ...
    /* Marshalling struct. */
    read_file_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(read_file_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(read_file_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (read_file_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _fileencryptor_ecall_info_table[fileencryptor_fcn_id_read_file].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (read_file_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(fileencryptor_read_file, read_file);
...
enum
{
    ...
    fileencryptor_fcn_id_oe_syscall_getpid_ocall = 62,
    fileencryptor_fcn_id_oe_syscall_getppid_ocall = 63,
    fileencryptor_fcn_id_oe_syscall_getpgrp_ocall = 64,
    fileencryptor_fcn_id_oe_syscall_getuid_ocall = 65,
    fileencryptor_fcn_id_oe_syscall_geteuid_ocall = 66,
    fileencryptor_fcn_id_oe_syscall_getgid_ocall = 67,
    fileencryptor_fcn_id_oe_syscall_getegid_ocall = 68,
    fileencryptor_fcn_id_oe_syscall_getpgid_ocall = 69,
    fileencryptor_fcn_id_oe_syscall_getgroups_ocall = 70,
    fileencryptor_fcn_id_oe_syscall_uname_ocall = 71,
    fileencryptor_fcn_id_oe_get_supported_attester_format_ids_ocall = 72,
    fileencryptor_fcn_id_oe_get_qetarget_info_ocall = 73,
    fileencryptor_fcn_id_oe_get_quote_ocall = 74,
    fileencryptor_fcn_id_oe_get_quote_verification_collateral_ocall = 75,
    fileencryptor_fcn_id_oe_verify_quote_ocall = 76,
    fileencryptor_fcn_id_oe_sgx_get_cpuid_table_ocall = 77,
    fileencryptor_fcn_id_oe_sgx_backtrace_symbols_ocall = 78,
    fileencryptor_fcn_id_oe_sgx_thread_wake_wait_ocall = 79,
    fileencryptor_fcn_id_oe_sgx_wake_switchless_worker_ocall = 80,
    fileencryptor_fcn_id_oe_sgx_sleep_switchless_worker_ocall = 81,
